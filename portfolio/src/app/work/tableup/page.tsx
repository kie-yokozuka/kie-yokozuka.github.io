...
export default function TableUpPage() {
  return (
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto px-4 sm:px-8 flex flex-col gap-16">
        ...
        <section className="pt-12 pb-8">
          <div className="flex flex-col lg:flex-row items-center gap-8">
            <div className="flex-1">
              <h1 className="text-4xl sm:text-5xl font-bold mb-4">Table Up</h1>
              <p className="text-lg text-gray-600">A restaurant reservation & waitlist app application</p>
            </div>
        ...
        <section>
          ...
          <div className="space-y-4 mb-8">
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>Table Up is an app that helps users find restaurants.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-red-500 mt-1">•</span>
                <span>Users can check availability.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-red-500 mt-1">•</span>
                <span>Users can book a table.</span>
              </li>
            </ul>
            <p>Users can join the waitlist.</p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {[
              ...
              { icon: <IconDuration />, title: "Duration", value: "3 weeks" },
              { icon: <IconPlatform />, title: "Platform", value: "Mobile app, Website" },
              { icon: <IconTools />, title: "Tools", value: "Figma, Miro, Lottie, UX.info" },
              { icon: <IconMethods />, title: "Methods", value: "User interview, UI/UX Research, Design Sprint, Atomic design" }
            ].map((item, i) => (
        ...
        <section>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            <p className="text-gray-700 leading-relaxed">
              Users often struggle to find and reserve tables at restaurants through multiple websites, 
              leading to a fragmented and time-consuming experience. The current process lacks real-time 
              availability information and efficient waitlist management.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4 mb-8">
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>Search by area, genre, or rating.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-1">•</span>
                <span>Easily check real-time waitlist.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-1">•</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm">
              <div className="w-full h-48 bg-gray-200 rounded-lg mb-3"></div>
              <p className="text-sm text-center">Restaurant Details</p>
            </div>
            <div className="bg-white rounded-lg p-4 shadow-sm">
              <div className="w-full h-48 bg-gray-200 rounded-lg mb-3"></div>
              <p className="text-sm text-center">Reservation/Waitlist</p>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-lg">Rie Yokozuka</h4>
                  <p className="text-gray-600">Full-time Student</p>
                </div>
                <div>
                  <h5 className="font-semibold mb-2">Background</h5>
                  <p className="text-sm text-gray-700">A busy student who loves trying new restaurants but often struggles with last-minute dining decisions.</p>
                </div>
                <div>
                  <h5 className="font-semibold mb-2">Goals</h5>
                  <p className="text-sm text-gray-700">Find restaurants quickly, check availability in real-time, and join waitlists easily.</p>
                </div>
                <div>
                  <h5 className="font-semibold mb-2">Frustrations</h5>
                  <p className="text-sm text-gray-700">Spending too much time calling restaurants, not knowing wait times, and missing out on popular spots.</p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <div className="grid grid-cols-7 gap-2">
                {['#FF0000', '#808080', '#0000FF', '#FFFF00', '#8B4513', '#800080', '#008000'].map((color, i) => (
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="flex gap-4">
                  <button className="bg-red-500 text-white px-4 py-2 rounded">Primary Button</button>
        ...
        <section>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {['Splash Screen', 'Login/Signup', 'Restaurant List', 'Restaurant Details'].map((title, i) => (
              <div key={i} className="bg-white rounded-lg p-4 shadow-sm">
                <div className="w-full h-48 bg-gray-200 rounded-lg mb-3"></div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              {
                title: "Heuristic Evaluation, Accessibility",
                content: "WCAG standard compliance, iOS/Android standard fit, several bugs to update."
              },
              {
                title: "Concept Testing",
                content: "Need for online waitlist creation feature, concerns about sharing personal info with restaurants."
              },
              {
        ...
        <section>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-1">•</span>
                <span>Keep consistency across pages.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-1">•</span>
                <span>Avoiding too much white space.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-1">•</span>
                <span>Need to improve accessibility.</span>
              </li>
            </ul>
          </div>
        </section>
